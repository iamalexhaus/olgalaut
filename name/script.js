...
var colors = ["rgba(188, 26, 58, .6)", "rgba(46, 204, 113, .4)", "rgba(188, 115, 26, .4)", "rgba(188, 115, 26, .4)", "rgba(236, 236, 231, .6)", "rgba(241, 240, 234, .4)"];

var colorsTwo = ["rgba(188, 26, 58, 1)", "rgba(46, 204, 113, 1)", "rgba(188, 115, 26, 1)", "rgba(188, 115, 26, 1)", "rgba(236, 236, 231, 1)", "rgba(241, 240, 234, 1)"];

var copy = "OLGA LAUT"; // Text to display
